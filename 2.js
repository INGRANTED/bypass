(function () {
  ...
  let _0x3f86cb = {
    ...
    apiBaseUrl: "https://alamin-api.amin89310.workers.dev",
    apiKey: "alamin",
    totpSecret: "K4XG2ZRGM5hhjTGM3Q",
  ...
  async function _0x43ce2f() {
    ...
    // ✅ update.json থেকে apiBaseUrl, apiKey, totpSecret নেবে (OVERRIDES data.json)
    try {
      ...
      if (!_0xUpdRes.ok) {
        ...
        if (_0xUpdData.apiBaseUrl) {
          ...
          _0x304696.log("CONFIG", "apiBaseUrl updated from update.json: " + _0x3f86cb.apiBaseUrl);
        }
        if (_0xUpdData.apiKey) {
          _0x3f86cb.apiKey = _0xUpdData.apiKey;
          _0x304696.log("CONFIG", "apiKey updated from update.json: " + _0x3f86cb.apiKey);
        }
        if (_0xUpdData.totpSecret) {
          _0x3f86cb.totpSecret = _0xUpdData.totpSecret;
          _0x2b860f.secret = _0xUpdData.totpSecret;
          _0x304696.log("CONFIG", "totpSecret updated from update.json: " + _0x3f86cb.totpSecret);
        }
      }
    } catch (_0xUpdErr) {
